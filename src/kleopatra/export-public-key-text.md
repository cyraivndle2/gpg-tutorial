...
2. 等待对方发来 [导入的公钥的指纹](import-public-key-text.md#fingerprint)，并校验其与 [导出的公钥指纹](#fingerprint) 是否一致。
