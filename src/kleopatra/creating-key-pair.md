...
2. 打开“文件”菜单，然后选择“创建 OpenPGP 密钥对”。
    ...
    ![创建 OpenPGP 密钥对菜单项](creating-key-pair/creating-oepnpgp-key-pair-menu-item.png)

3. 输入关联密钥对的称谓（对应界面上的“名字”）和电子邮件地址。所输入的称谓和电子邮件地址应能够使收到公钥的人辨认出这个公钥的身份。
    ...
    ![称谓和电子邮件地址](creating-key-pair/name-email.png)
...
6. 为新创建的密钥对设置私钥密码。在“Passphrase”和“Repeat”输入框中输入密码，然后点击“OK”按钮。
    ...
    ![设置私钥密码](creating-key-pair/passphrase.png)
